...
# This probably shouldn't be in files/, put it where?
class InstanceList < Sensu::Plugin::Check::CLI
  option :aws_access_key,
         short: '-a AWS_ACCESS_KEY',
         long: '--aws-access-key AWS_ACCESS_KEY',
         description: 'AWS Access Key. Either set ENV[\'AWS_ACCESS_KEY_ID\'] or provide '\
           'it as an option',
         required: false
  ...
  option :aws_secret_access_key,
         ...
         description: 'AWS Secret Access Key. Either set ENV[\'AWS_SECRET_ACCESS_KEY\']'\
  ...
  def write_instance_cache(instance_list)
    ...
    File.open('/var/cache/instance_list.json.new', 'w')  { |f|  f.write(instance_list.to_json) }
